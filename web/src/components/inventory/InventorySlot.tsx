      ...
      <div
        ...
        className={
          (item.metadata?.type === 'Special' || item.metadata?.type === 'Rare') && (
            `inventory-slot-${item.metadata.type.toLowerCase()}`
          ) || ('inventory-slot')
        }
        style={{
          filter:
          ...
          >
            ...
            <div>
                ...
                <>
                  {item?.currency !== 'money' && item.currency !== 'black_money' && item.price > 0 && item.currency ? (
                    <div className="item-slot-currency-wrapper">
                      ...
                      /> */}
                      <p>{item.price.toLocaleString('en-us')} x</p>
                      <p>{Items[item.currency]?.label}</p>
                    </div>
                  ) : (
                    <>
                      {item.price > 0 && (
              ...
              {inventoryType !== 'shop' && item?.durability !== undefined ? (
                ...
                <div className="inventory-slot-label-box">
                <div className="inventory-slot-label-text" style={{paddingBottom: '3px'}}>
                  {item.metadata?.label ? item.metadata.label : Items[item.name]?.label || item.name}
                </div>
              </div>               
              )}
